...
$string["donate"] = 'Finance the project';
$string["no-iddona"] = 'You must choose one project to donate. Wait to be redirected or click on Continue';
